...
public class ExcelProducer {
    private final ExcelBuilderWithPaging excelBuilderWithPaging = new ExcelBuilderWithPaging();
    private final ExcelBuilderDirect excelBuilderDirect = new ExcelBuilderDirect();
